...
return [
    ...
    'needVerification'  => 'Escanea el código QR para activar su cuenta.',

    // Register
    'googleApp'  => 'Escanea este código QR utilizando una aplicación de verificación de doble factor (<a href="https://play.google.com/store/apps/details?id=com.google.android.apps.authenticator2&hl=es" target="_blank">Android</a>/<a href="https://apps.apple.com/es/app/google-authenticator/id388497605" target="_blank">iOS</a>) y ingrese una contraseña única (OTP) para activar su cuenta.',
